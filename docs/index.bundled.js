 ...
 * http://polymer.github.io/PATENTS.txt
 */
const u=new WeakMap,f=t=>"function"==typeof t&&u.has(t),w={},x={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const m=` ${i} `;class g{constructor(t,s,i,e){this.strings=t,this.values=s,this.type=i,this.processor=e}getHTML(){const t=this.strings.length-1;let s="",n=!1;for(let o=0;o<t;o++){const t=this.strings[o],r=t.lastIndexOf("\x3c!--");n=(r>-1||n)&&-1===t.indexOf("--\x3e",r+1);const a=l.exec(t);s+=null===a?t+(n?m:e):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+i}return s+=this.strings[t],s}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=t=>null===t||!("object"==typeof t||"function"==typeof t),v=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class S{constructor(t,s,i){this.dirty=!0,this.element=t,this.name=s,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new k(this)}_getValue(){const t=this.strings,s=t.length-1;let i="";for(let e=0;e<s;e++){i+=t[e];const s=this.parts[e];if(void 0!==s){const t=s.value;if(y(t)||!v(t))i+="string"==typeof t?t:String(t);else for(const s of t)i+="string"==typeof s?s:String(s)}}return i+=t[s],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class k{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===w||y(t)&&t===this.value||(this.value=t,f(t)||(this.committer.dirty=!0))}commit(){for(;f(this.value);){const t=this.value;this.value=w,t(this)}this.value!==w&&this.committer.commit()}}class C{constructor(t){this.value=void 0,this.s=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(h()),this.endNode=t.appendChild(h())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.i(this.startNode=h()),t.i(this.endNode=h())}insertAfterPart(t){t.i(this.startNode=h()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.s=t}commit(){if(null===this.startNode.parentNode)return;for(;f(this.s);){const t=this.s;this.s=w,t(this)}const t=this.s;t!==w&&(y(t)?t!==this.value&&this.o(t):t instanceof g?this.h(t):t instanceof Node?this.l(t):v(t)?this.p(t):t===x?(this.value=x,this.clear()):this.o(t))}i(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.i(t),this.value=t)}o(t){const s=this.startNode.nextSibling,i="string"==typeof(t=null==t?"":t)?t:String(t);s===this.endNode.previousSibling&&3===s.nodeType?s.data=i:this.l(document.createTextNode(i)),this.value=t}h(t){const s=this.options.templateFactory(t);if(this.value instanceof b&&this.value.template===s)this.value.update(t.values);else{const i=new b(s,t.processor,this.options),e=i._clone();i.update(t.values),this.l(e),this.value=i}}p(t){Array.isArray(this.value)||(this.value=[],this.clear());const s=this.value;let i,e=0;for(const n of t)i=s[e],void 0===i&&(i=new C(this.options),s.push(i),0===e?i.appendIntoPart(this):i.insertAfterPart(s[e-1])),i.setValue(n),i.commit(),e++;e<s.length&&(s.length=e,this.clear(i&&i.endNode))}clear(t=this.startNode){s(this.startNode.parentNode,t.nextSibling,this.endNode)}}class _{constructor(t,s,i){if(this.value=void 0,this.s=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=s,this.strings=i}setValue(t){this.s=t}commit(){for(;f(this.s);){const t=this.s;this.s=w,t(this)}if(this.s===w)return;const t=!!this.s;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.s=w}}class $ extends S{constructor(t,s,i){super(t,s,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new j(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class j extends k{}let O=!1;(()=>{try{const t={get capture(){return O=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class A{constructor(t,s,i){this.value=void 0,this.s=void 0,this.element=t,this.eventName=s,this.eventContext=i,this.u=t=>this.handleEvent(t)}setValue(t){this.s=t}commit(){for(;f(this.s);){const t=this.s;this.s=w,t(this)}if(this.s===w)return;const t=this.s,s=this.value,i=null==t||null!=s&&(t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive),e=null!=t&&(null==s||i);i&&this.element.removeEventListener(this.eventName,this.u,this.m),e&&(this.m=M(t),this.element.addEventListener(this.eventName,this.u,this.m)),this.value=t,this.s=w}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const M=t=>t&&(O?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,s,i,e){const n=s[0];if("."===n){return new $(t,s.slice(1),i).parts}return"@"===n?[new A(t,s.slice(1),e.eventContext)]:"?"===n?[new _(t,s.slice(1),i)]:new S(t,s,i).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var st=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let it=class extends tt{constructor(){super(...arguments),this.name="World",this.count=0}render(){return E`
      <h1>Abigo, ${this.name}!</h1>
      <button @click=${this._onClick} part="button">
        Click Count: ${this.count}
      </button>
      <slot></slot>
    `}_onClick(){this.count++}};it.styles=Q`
    :host {
      display: block;
  ...
  `,st([D()],it.prototype,"name",void 0),st([D({type:Number})],it.prototype,"count",void 0),it=st([W("my-element")],it);var et=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let nt=class extends tt{constructor(){super(),this.value="Install",this.background="#602ac1",this.color="#fff",this.size="56px",this._prompt=!1,this._trigger=!1}render(){return this._trigger?E`
    ...
    `:""}_onClick(){this._trigger=!1,this.requestUpdate(),this._prompt.prompt()}connectedCallback(){super.connectedCallback(),window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),this._prompt=t,this._trigger=!0,this.requestUpdate()})}};nt.styles=Q`
  .fn-pwa-button{
  ...
  `,et([D({type:String})],nt.prototype,"value",void 0),et([D({type:String})],nt.prototype,"background",void 0),et([D({type:String})],nt.prototype,"color",void 0),et([D({type:String})],nt.prototype,"size",void 0),nt=et([W("fn-pwa-button")],nt);var ot=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let rt=class extends tt{constructor(){super(),this.value="Installing uses almost no storage and provides a quick way  to return to this app",this.title="Install",this.background="#602ac1",this.show="true",this.color="#fff",this._prompt=!1,this._trigger=!1,setTimeout(()=>{this._trigger=!1,this.requestUpdate()},7e3)}render(){return this._trigger&&"true"===this.show?E`
    ...
    `:""}_onClick(){this._trigger=!1,this.requestUpdate(),this._prompt.prompt()}connectedCallback(){super.connectedCallback(),window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),this._prompt=t,this._trigger=!0,this.requestUpdate()})}};rt.styles=Q`
  .fn-pwa-banner{
  ...
  `,ot([D({type:String})],rt.prototype,"value",void 0),ot([D({type:String})],rt.prototype,"title",void 0),ot([D({type:String})],rt.prototype,"background",void 0),ot([D({type:String})],rt.prototype,"show",void 0),ot([D({type:String})],rt.prototype,"color",void 0),rt=ot([W("fn-pwa-banner")],rt);var at=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let ht=class extends tt{constructor(){super(),this.background="#602ac1",this.color="#fff",this.value="It looks like you're offline",this.show=!1}render(){return this.show?E`
    ...
    `:""}_onClick(){this.show=!1,this.requestUpdate()}connectedCallback(){super.connectedCallback(),window.addEventListener("online",()=>{this.show=!1,this.requestUpdate()}),window.addEventListener("offline",()=>{this.show=!0,this.requestUpdate()})}};ht.styles=Q`
    :host{
        position:fixed;
        bottom:10px;
        width:80vw;
  ...
  `,at([D({type:String})],ht.prototype,"background",void 0),at([D({type:String})],ht.prototype,"color",void 0),at([D({type:String})],ht.prototype,"value",void 0),ht=at([W("fn-pwa-status")],ht);
